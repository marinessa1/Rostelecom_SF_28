...
# python -m pytest -v --driver Chrome --driver-path /SF_module28_RT/chromedriver_mac_arm64/chromedriver test_SF-RT.py
...
#
# RT-001
# Логотип Ростелеком (переход на форму авторизации) отображен на странице
